                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class='text-center'>
                                    ...
                                    <td class='text-left'>{{ $row->komisi }}</td>
                                    <td>
                ...
                <form>
                    <div class='modal-body'>
                        ...
                        <div class='form-group'>
                            ...
                            <input type='text' wire:model='harga' id='harga' class='form-control'>
                            @error('harga') <span class='text-danger'>{{ $message }}</span> @enderror
                        </div>
                        <div class='form-group'>
                            <label for='komisi'>Komisi</label>
                            <input type='text' wire:model='komisi' id='komisi' class='form-control'>
